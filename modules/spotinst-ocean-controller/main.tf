resource "kubernetes_namespace" "spot_ns" {
  metadata {
...
resource "kubernetes_secret" "this" {
  depends_on = [kubernetes_namespace.spot_ns]
...
resource "kubernetes_cluster_role" "this" {
  ...
  rule {
    ...
    resources  = ["sparkapplications", "wavecomponents", "wavestacks"]
    verbs      = ["get", "list"]
  }

  rule {
    api_groups = ["bigdata.spot.io"]
    resources  = ["bigdatastacks"]
    verbs      = ["get", "list", "patch", "update", "create", "delete"]
  }
}
